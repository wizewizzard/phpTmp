    ...
    <div rel="#general" class="tab-content general">
        ...
        <div class="inner table">
            <p style="font-size: 14px; padding: 40px 20px; -webkit-column-count: 2; -moz-column-count: 2; column-count: 2;">
                Группа компаний "Сибирские фасады" создана в 2000 году и объединяет предприятия в Новосибирске, Новокузнецке, Тюмени и Барнауле. Компания сотрудничает с ведущими производителями и поставщиками фасадных и витражных конструкций и имеет собственное производство. Это дает "Сибирским фасадам" возможность качественно выполнять услуги по проектированию, изготовлению, комплектации и монтажу фасадных и витражных конструкций в различных регионах России.
            </p>
        </div>
    </div>
